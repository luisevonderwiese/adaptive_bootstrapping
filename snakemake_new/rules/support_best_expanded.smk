rule support_best_expanded:
    input:
       bs_trees = bootstrapping_prefix + ".raxml.bootstraps",
       best_tree = raxmlng_prefix + ".raxml.bestTreeCollapsedStrict"
    output:
        support_tree = best_expanded_support_prefix + ".raxml.support",
    params:
        prefix  = best_expanded_support_prefix,
    log:
        cmdlog = best_expanded_support_prefix + ".raxml.cmdlog",
    threads: 8
    resources:
        mem_mb = 4000,
        disk_mb = 4000,
